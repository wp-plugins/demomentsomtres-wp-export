...
add_action('export_wp', 'DeMomentSomTres_export_wp');
 ...
 */
function DeMomentSomTres_export_wp() {
    global $wpdb, $post;
    ...
    if ('all' != $args['content']):
        $post_ids = demomentsomtres_add_attachments($post_ids);
    endif;
